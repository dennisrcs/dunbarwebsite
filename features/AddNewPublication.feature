...
# the sad path is not tested because it is not included in the controllers. Cucumber does not catch the exceptions.
####################################################################################################################
...
#   And I press "Create Publication"
#   Then I should be on the Publications page
#   And I should not see "Cellular Toxicity Induced Through Photorelease of a Caged Bioactive Molecule: Design of Potential Dual-Action Ru(II) Complexe"
