...
user1 = User.create(:username => 'byter', :email => 'byters606@googlegroups.com', :password => 'byter123', :password_confirmation => 'byter123')
...
user2 = User.create(:username => 'bender', :email => 'bender@gmail.com', :password => 'bender123', :password_confirmation => 'bender123')
...
user3 = User.create(:username => 'calculon', :email => 'calculon@gmail.com', :password => 'calculon123', :password_confirmation => 'calculon123')
...
user4 = User.create(:username => 'devil', :email => 'devil@gmail.com', :password => 'devil123', :password_confirmation => 'devil123')
...
user5 = User.create(:username => 'police', :email => 'police@gmail.com', :password => 'police123', :password_confirmation => 'police123')
...
user6 = User.create(:username => 'roberto', :email => 'roberto@gmail.com', :password => 'roberto123', :password_confirmation => 'roberto123')
