...
member4 = Member.create(:name => 'Irving Solis', :position => 'PhD Student', :telephone => '(979) 169-9253', :fax => '(979) 779-7382', :previous_affiliation => 'Universidad Nacional do Mexico',
                        :bio => 'Hey, my name is Irving Solis! :)', :building => 'Chemistry Building', :office => '2311', :birthplace => 'Monterrey, México',
                        :is_current_member => false, :is_listed => true, :rank => 3, :link => 'http://www.google.com.br',
...
member6 = Member.create(:name => 'Xuesu Xiao', :position => 'Undergraduate Student', :telephone => '(979) 835-1259', :fax => '(979) 148-7289', :previous_affiliation => 'Carnegie Mellon University',
                        :bio => 'Hey, my name is Xuesu Xiao! :)', :building => 'Chemistry Building', :office => '2311', :birthplace => 'Xian, China',
                        :is_current_member => false, :is_listed => false, :rank => 5, :link => 'http://www.google.com.br',
...
collaboration1 = Collaboration.create(:researcher => "Dr. Thomas Davis", :link => "https://www.caltech.edu/", :affiliation => "California Institute of Technology", :picture_path => "/uploads/collaborations/logo_caltech.png", :description => "We are investigating the interactions of metal-metal bonded systems vis-à-vis their interactions with DNA, the primary target of platinum and platinum group metal anticancer agents. Our work has unearthed new concepts regarding viable substitution pathways and binding modes of dimetal units with DNA the results of which are being applied to the design of new and improved dirhodium anticancer active candidates.")
collaboration2 = Collaboration.create(:researcher => "Dr. Shawna Lewis", :link => "https://www.stanford.edu", :affiliation => "Stanford University", :picture_path => "/uploads/collaborations/logo_stanford.png", :description => "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque vitae dui mauris. Fusce pulvinar mollis convallis. Maecenas nisi nibh, posuere et sapien a, laoreet finibus lorem. Fusce ac auctor mi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Proin pretium suscipit egestas. Aenean tristique porttitor urna, a dictum.")
collaboration3 = Collaboration.create(:researcher => "Dr. Kumar Patel", :link => "https://www.tamu.edu/", :affiliation => "Texas A&M University", :picture_path => "/uploads/collaborations/logo_tamu.png", :description => "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque convallis, ex id porttitor blandit, purus lectus tincidunt tellus, nec volutpat nulla justo id sapien. In tincidunt elit at ex vulputate, vitae cursus magna aliquam. Morbi maximus urna vel ante dapibus suscipit at vel dui. Pellentesque sodales diam eget sapien luctus eleifend. In finibus metus fringilla dui vulputate dignissim. Etiam sed.")
collaboration4 = Collaboration.create(:researcher => "Dr. Chou Sheu-fuh", :link => "https://www.utexas.edu/", :affiliation => "University of Texas", :picture_path => "/uploads/collaborations/logo_ut.png", :description => "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sodales dignissim libero vel dapibus. Quisque at nisl pretium, posuere libero sit amet, iaculis ipsum. Suspendisse feugiat suscipit diam sed convallis. Pellentesque sagittis felis nisi, et pretium diam gravida maximus. Morbi.")

event1 = Event.create(:title => 'Elementary Science Demonstrations', :date => 'July 2016', :picture_path => '/uploads/events/outreach1.png', :summary => 'Periodically throughout the year, students from the lab go out to local elementary schools in order to put on a chemistry show. Demonstrations include paper chromatography of ink, polymerization of borax and glue (making a slime), magnetic slime, and magic sand.', :content => 'this is the content for now')
...
link1 = Link.create(:title => "Texas A&M University", :url => "http://www.tamu.edu/", :picture_path => '/uploads/links/link1.png', :description => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce tincidunt sagittis leo eu aliquet. Vestibulum tristique semper egestas. Aenean sed vehicula eros. Sed placerat metus vitae arcu facilisis, ac egestas odio aliquam. Vivamus quis velit sed libero eleifend pretium.')
link2 = Link.create(:title => "Chemistry @ Texas A&M University", :url => "http://www.chem.tamu.edu/", :picture_path => '/uploads/links/link2.png', :description => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse ut neque nulla. Suspendisse potenti. Nunc congue pellentesque massa, sit amet interdum nulla malesuada eu. Curabitur lacus nisl, scelerisque quis dapibus in, tempus a libero.')
link3 = Link.create(:title => "National Science Foundation", :url => "http://www.nsf.gov/", :picture_path => '/uploads/links/link3.png', :description => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis erat metus, tincidunt at erat sit amet, finibus gravida sem. Mauris ut varius nulla. Pellentesque pretium rutrum ullamcorper.')
