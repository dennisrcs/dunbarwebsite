...
# Users seed
user1 = User.create(:username => 'byter', :is_admin => true, :activated => true, :activated_at => Time.zone.now, :email => 'cunhadrcs@gmail.com', :password => 'byter123', :password_confirmation => 'byter123')
